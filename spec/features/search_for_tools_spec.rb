...
feature "From the home page, a user should be able to search for tools." do
  ...
  scenario  "If a user enters a search term and the tool does not exist, the user should see a message saying so.", js: true do
    visit '/'
  ...
  scenario "If a user enters a search term and the tool exists, display the tool in the search results", js: true do
